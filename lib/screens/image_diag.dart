                ...
                child: Padding(
                  ...
                  child: Column(
                    children: [
                      ...
                      Text(
                        'Risk: ${(prob[1] * 100).toInt() > 69 ? 'Safe' : (prob[1] * 100).toInt() > 59 ? 'Moderate' : 'High'}',
                        style: TextStyle(
                          fontFamily: 'geb',
                          fontSize: 19,
                        ),
                      ...
                      Container(
                        ...
                        decoration: BoxDecoration(
                          borderRadius: BorderRadius.circular(10),
                          color: (prob[1] * 100).toInt() > 69
                              ? Colors.green.shade200
                              : (prob[1] * 100).toInt() > 59
                                  ? Colors.orange.shade200
                                  : Colors.red.shade200,
                        ),
                        child: (prob[1] * 100).toInt() > 69
                            ? Column(
                                crossAxisAlignment: CrossAxisAlignment.start,
                                children: [
                                  Text(
                                    'Interpretation: Based on facial image analysis using our AI model, your child shows no significant signs of autism spectrum disorder (ASD). Their behaviors align with typical developmental patterns for their age. These results are generated by AI and may not be as accurate as a professional healthcare evaluation.',
                                    style: TextStyle(
                                      fontFamily: 'gsb',
                                      fontSize: 15,
                                    ),
                            ...
                            : (prob[1] * 100).toInt() > 59
                                ? Column(
                                    ...
                                    children: [
                                      Text(
                                        'Interpretation: Based on facial image analysis, our AI model indicates mild signs of autism spectrum disorder (ASD), such as difficulty interpreting social cues or some repetitive behaviors. A follow-up consultation with a healthcare provider is recommended for further evaluation. These results are generated by AI and may not replace a professional diagnosis. Please consult a specialist for confirmation.',
                                        style: TextStyle(
                                          fontFamily: 'gsb',
                                          fontSize: 15,
                                        ),
                                ...
                                : Column(
                                    ...
                                    children: [
                                      Text(
                                        'Interpretation: The AI model indicates significant signs of autism spectrum disorder based on facial expressions and social cues. Immediate follow-up with an autism specialist is recommended for further assessment. These results are generated by AI and may not replace a professional diagnosis. Please consult a specialist for confirmation.',
                                        style: TextStyle(
                                          fontFamily: 'gsb',
                                          fontSize: 15,
                                        ),
